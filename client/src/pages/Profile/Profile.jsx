    ...
    <div className="w-full min-h-screen bg-[#fdfbf7] pt-32 pb-20 px-4 md:px-10">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <form onSubmit={submitHandler} className="space-y-4 text-left">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border rounded-lg text-sm outline-none focus:border-[#d4a017]"
                  />
                </div>
                <div>
                  <label className="text-xs font-bold text-stone-400 uppercase">
                ...
                <div className="flex gap-2 mt-4">
                  <button
                    ...
                    className="flex-1 py-2 border border-stone-300 rounded-lg text-xs font-bold uppercase"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 py-2 bg-[#4a3b2a] text-white rounded-lg text-xs font-bold uppercase hover:bg-[#d4a017]"
                  >
                    Save
                  </button>
                </div>
        ...
        <div className="md:col-span-2">
          <h2 className="text-3xl font-playfair font-bold text-[#4a3b2a] mb-6">
            My Orders
          </h2>
                  ...
                  <tbody>
                    ...
                    {orders
                      ...
                      .map((order) => (
                        <tr
                          key={order._id}
                          className="border-b border-[#4a3b2a]/5 last:border-0 hover:bg-stone-50 transition-colors"
                        >
                          <td className="p-5 font-mono text-xs text-[#4a3b2a]">
                            #{order._id.substring(0, 10)}...
                          </td>
                          <td className="p-5 text-sm text-stone-500">
                            {order.createdAt.substring(0, 10)}
                          </td>
                          <td className="p-5 font-bold text-[#4a3b2a]">
                            ₹{order.totalPrice}
                          </td>
